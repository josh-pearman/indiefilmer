...
export function CastSchedule({ shootDays }: CastScheduleProps) {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Schedule</CardTitle>
        <p className="text-sm text-muted-foreground">
          Shoot days this cast member is needed (from their scene assignments).
        </p>
      </CardHeader>
      <CardContent>
        {shootDays.length === 0 ? (
          <p className="text-sm text-muted-foreground">
            No scheduled shoot days yet.
          </p>
        ) : (
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border">
                  ...
                  <th className="pb-2 text-left font-medium">Scenes</th>
